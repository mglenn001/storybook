...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-PT2GQT6J.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./@storybook_test.js"), act = await getAct();
...
//# sourceMappingURL=chunk-V2LSTAU3.js.map
