...
function $h(e, t) {
  ...
  if (e.type === "attribute" && delete t.value, e.type === "docType" && delete t.value, e.type === "angularControlFlowBlock" && (r = e.parameters) != null && r.children) for (let n of t.parameters.children) rE.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
function PE(e, t) {
  ...
  let n = false;
  if (e.type === "element" && e.namespace === "svg") if (_E(e, (o) => o.fullName === "svg:foreignObject")) n = true;
...
function eR(e) {
  ...
  function f() {
    ...
    for (y = 0; y < n.length; y++) D6 = n[y], x = D6[D6.length - 1], C = D6.substring(0, D6.length - 1), E = parseInt(C, 10), R = parseFloat(C), K2.test(C) && x === "w" ? ((w || m) && (g = true), E === 0 ? g = true : w = E) : QE.test(C) && x === "x" ? ((w || m || v) && (g = true), R < 0 ? g = true : m = R) : K2.test(C) && x === "h" ? ((v || m) && (g = true), E === 0 ? g = true : v = E) : g = true;
    if (!g) b.source = { value: r, startOffset: c }, w && (b.width = { value: w }), m && (b.density = { value: m }), v && (b.height = { value: v }), d.push(b);
    else throw new Error(`Invalid srcset descriptor found in "${e}" at "${D6}".`);
  }
  a(f, "d");
}
function rR(e) {
...
function iR(e, t) {
  ...
  if (r.fullName === "style" && !t.parentParser && !n.includes("{{")) return async (o) => Ji(await o(n, { parser: "css", __isHTMLStyleAttribute: true }));
}
function lR(e, t) {
  let { root: r } = e;
...
function vR(e) {
  return async (t, r, n, o) => {
    ...
    if (i) return i = Nh(i, (l) => typeof l == "string" ? Ye(false, l, '"', "&quot;") : l), [n.node.rawName, '="', ce(i), '"'];
  };
}
function bR(e) {
...
function wm(e, t, r) {
  ...
  if (n === "vue") {
    if (d.some((C) => C.type === "docType" && C.value === "html" || C.type === "element" && C.name.toLowerCase() === "html")) return wm(
      e,
      ym,
      r
    );
    ...
    for (let [C, E] of d.entries()) {
      ...
      if (R === null) h5 = D6().errors, d[C] = x(E);
      else if (mA(E, r)) {
  ...
  let f = a((b) => {
    ...
    switch (b.type) {
      case "element":
        f(b);
        for (let D6 of b.attrs) f(D6), D6.valueSpan ? (D6.value = D6.valueSpan.toString(), /["']/u.test(D6.value[0]) && (D6.value = D6.value.slice(
          1,
          -1
        ))) : D6.value = null;
        break;
    ...
    if (b.type === "element" && (i && (!b.namespace || b.namespace === b.tagDefinition.implicitNamespacePrefix || Ia(b)) && (b.name = w(
      b.name,
      (D6) => pA.has(D6)
    )), l)) for (let D6 of b.attrs) D6.namespace || (D6.name = w(D6.name, (x) => ac.has(b.name) && (ac.get("*").has(x) || ac.get(
      b.name
    ).has(x))));
  }, "D"), v = a((b) => {
...
var xm = S(() => {
  kC = Object.defineProperty, Eh = a((e) => {
    ...
    for (var r in t) kC(e, r, { get: t[r], enumerable: true });
...
` && ++s == r)); ) ;
  ...
  mS = (_n = class {
    ...
    hasProperty(t, r, n) {
      if (n.some((o) => o.name === ih.name)) return true;
      if (t.indexOf("-") > -1) {
        if (sh(t) || uh(t)) return false;
        if (n.some((o) => o.name === ah.name)) return true;
      }
...
`);
    ...
    _tokenizeExpansionForm() {
      ...
      if (WS(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), true;
    ...
    _endToken(t, r) {
      if (this._currentTokenStart === null) throw new rc(
        "Programming error - attempted to end a token when there was no start to the token",
        this._currentTokenType,
        this._cursor.getSpan(r)
      );
      if (this._currentTokenType === null) throw new rc("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
    ...
    _isBlockStart() {
      if (this._tokenizeBlocks && this._cursor.peek() === 64) {
        let t = this._cursor.clone();
        if (t.advance(), vh(t.peek())) return true;
      }
      return false;
    }
    _readUntil(t) {
  ...
  vm = (sr = class {
    ...
    processEscapeSequence() {
      ...
      } else Fc(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
    }
    decodeHexDigits(t, r) {
...
`) {
      ...
      for (; this._peek.type === 8 || this._peek.type === 5 || this._peek.type === 9; ) t = this._advance(), r.push(t), t.type === 8 ? o += t.parts.join("").replace(/&([^;]+);/g, yh) : t.type === 9 ? o += t.parts[0] : o += t.parts.join("");
      if (o.length > 0) {
        let i = t.sourceSpan;
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        if ($i(l.name) ? l.name === t : (t == null || l.name.toLowerCase() === t.toLowerCase()) && l instanceof r) return l.endSourceSpan = n, l.sourceSpan.end = n !== null ? n.end : l.sourceSpan.end, this._containerStack.splice(i, this._containerStack.length - i), !o;
    ...
    _consumeAttr(t) {
      ...
      let i = "", l = [], s, c;
      if (this._peek.type === 16) for (s = this._peek.sourceSpan, c = this._peek.sourceSpan.end; this._peek.type === 16 || this._peek.type === 17 || this._peek.type === 9; ) {
        let d = this._advance();
...
function Cm(e, t, r, n, o) {
  ...
  for (var s = 0, c = i.length, p = 0, d = 0; s < c; s++) {
    var h5 = i[s];
    if (h5.removed) h5.value = e.join(n.slice(d, d + h5.count)), d += h5.count;
    else {
      if (!h5.added && o) {
      ...
      } else h5.value = e.join(r.slice(p, p + h5.count));
...
function tF(e) {
  ...
  function n(i, l, s) {
    ...
    if (i.type === nt) return ((p = s == null ? void 0 : s[l - 1]) == null ? void 0 : p.type) === Ae && s[l - 1].hard ? void 0 : "breakParent";
    if (i.type === jt) return "trim";
    if (i.type === $t) return "indent(" + n(i.contents) + ")";
    if (i.type === Vt) return i.n === Number.NEGATIVE_INFINITY ? "dedentToRoot(" + n(i.contents) + ")" : i.n < 0 ? "dedent(" + n(i.contents) + ")" : i.n.type === "root" ? "markAsRoot(" + n(i.contents) + ")" : "align(" + JSON.stringify(i.n) + ", " + n(i.contents) + ")";
    if (i.type === Xe) return "ifBreak(" + n(i.breakContents) + (i.flatContents ? ", " + n(i.flatContents) : "") + (i.groupId ? (i.flatContents ? "" : ', ""') + `, { groupId: ${o(i.groupId)} }` : "") + ")";
    if (i.type === Wt) {
      let d = [];
...
function uF(e) {
  if (e.type === We && e.break || e.type === Ae && e.hard || e.type === nt) return true;
}
function cF(e) {
...
function Lm(e) {
  for (e = [...e]; e.length >= 2 && De(false, e, -2).type === Ae && De(false, e, -1).type === nt; ) e.length -= 2;
  if (e.length > 0) {
          ...
          case je: {
            ...
            if (!w.break && ll(m, l, v, y, r)) l.push(m);
              ...
              if (w.break) {
                ...
                break;
              } else for (let D6 = 1; D6 < w.expandedStates.length + 1; D6++) if (D6 >= w.expandedStates.length) {
                l.push({ ind: f, mode: je, doc: b });
                break;
              } else {
...
function PF(e, t) {
  ...
  for (let [g, w] of f.entries()) {
    ...
    let R;
    if (l ? R = [w] : (m.enclosingNode = y, m.precedingNode = v, m.followingNode = b, R = [m, D6, x, C, E]), HF(D6, x, f, g)) m.placement = "ownLine", p(...R) || (b ? fo(b, m) : v ? ho(v, m) : Vr(y || C, m));
    else if (zF(D6, x, f, g)) m.placement = "endOfLine", d(...R) || (v ? ho(v, m) : b ? fo(b, m) : Vr(y || C, m));
    else if (m.placement = "remaining", !h5(...R)) if (v && b) {
      let F = n.length;
...
function HF(e, t, r, n) {
  ...
  if (i) for (let p = n - 1; p >= 0; p--) {
    ...
    if (h5 !== i || !bg(e.slice(s(d), c))) break;
    c = l(d);
  }
...
function zF(e, t, r, n) {
  ...
  if (i) for (let p = n + 1; p < r.length; p++) {
    ...
    if (h5 !== i || !bg(e.slice(c, l(d)))) break;
    c = s(d);
  }
  return pr(e, c);
}
function Tm(e, t) {
  ...
  for (let p of [i, l]) p.comments && p.comments.length > 1 && p.comments.sort((d, h5) => t.locStart(d) - t.locStart(h5));
  e.length = 0;
}
function Ic(e, t, r) {
...
function xg({ plugins: e = [], showDeprecated: t = false } = {}) {
  ...
  for (let o of XF(Object.assign({}, ...e.map(({ options: i }) => i), GF))) !t && o.deprecated || (Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((i) => !i.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...YF(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter((i) => {
    var l;
...
function rk(e, t) {
  ...
  for (; h5 < o; ) for (l = t.charCodeAt(i + h5), c = h5++, s = h5, d = 0; d < n; d++) p = l === zm[d] ? c : c + 1, c = Bc[d], s = Bc[d] = c > s ? p > s ? s + 1 : p : p > c ? c + 1 : p;
  return s;
}
function ok(e, t) {
...
function Ak(e, { isCLI: t, FlagSchema: r }) {
  ...
  for (let o of e) n.push(Fk(o, { isCLI: t, optionInfos: e, FlagSchema: r })), o.alias && t && n.push(ik.create({ name: o.alias, sourceName: o.name }));
  return n;
}
...
async function Bk(e, t = {}) {
  ...
  for (let [f, g] of Object.entries(h5)) (n[f] === null || n[f] === void 0) && (n[f] = g);
...
function Jk(e, t, r) {
  ...
  if (Gk(t)) {
    let g = Yk(p, d);
    h5 = g, f = g;
  } else ({ startNode: h5, endNode: f } = Xk(p, d, t));
...
async function _g(e, t, r = 0) {
  ...
  if (t.cursorOffset >= 0) {
    let c, p, d, h5;
    if ((t.cursorNode || t.nodeBeforeCursor || t.nodeAfterCursor) && l.cursorNodeText) if (d = l.cursorNodeStart, h5 = l.cursorNodeText, t.cursorNode)
    ...
    else c = 0, p = o, d = 0, h5 = l.formatted;
    let f = t.cursorOffset - c;
    if (p === h5) return { formatted: l.formatted, cursorOffset: d + f, comments: s };
    let g = p.split("");
    g.splice(f, 0, Zm);
...
var jg = S(() => {
  DA = Object.create, Yc = Object.defineProperty, xA = Object.getOwnPropertyDescriptor, CA = Object.getOwnPropertyNames, EA = Object.getPrototypeOf, RA = Object.prototype.hasOwnProperty, eg = a((e) => {
    ...
    for (var r in t) Yc(e, r, { get: t[r], enumerable: true });
  }, "Bt"), SA = a((e, t, r, n) => {
    if (t && typeof t == "object" || typeof t == "function") for (let o of CA(t)) !RA.call(e, o) && o !== r && Yc(e, o, { get: a(
      () => t[o],
      "get"
    ...
    function n(i, l, s) {
      ...
      if (b) for (let x = 0; x <= b; x++) {
        ...
        if (!g) D6[C] = true;
          ...
          let E = l[C - 1].length;
          D6[C] = [g, E - g + 1];
        } else if (x === b) D6[C] = [0, m];
        else {
          let E = l[C - x].length;
          D6[C] = [0, E];
        }
      }
      else g === m ? g ? D6[f] = [g, 0] : D6[f] = true : D6[f] = [g, m - g];
 ...
 `, c.gutter(D6.replace(/\d/g, " ")), " ", R, c.marker("^").repeat(F)].join(""), C && s.message && (E += " " + c.message(s.message));
        ...
        } else return ` ${c.gutter(D6)}${v.length > 0 ? ` ${v}` : ""}`;
      }).join(`
`);
...
${m}`), m;
  ...
  mt.prototype = { diff: a(function(e, t) {
    ...
    function y() {
      for (var D6 = Math.max(m, -p); D6 <= Math.min(v, p); D6 += 2) {
        ...
        if (!A || R && C.oldPos < E.oldPos ? x = i.addToPath(E, true, false, 0, n) : x = i.addToPath(C, false, true, 1, n), w = i.extractCommon(
          ...
          D6,
          n
        ), x.oldPos + 1 >= c && w + 1 >= s) return l(Cm(i, x.lastComponent, t, e, i.useLongestToken));
        g[D6] = x, x.oldPos + 1 >= c && (v = Math.min(v, D6 - 1)), w + 1 >= s && (m = Math.max(m, D6 + 1));
      }
      p++;
    }
    if (a(y, "C"), o) a(function D6() {
      setTimeout(function() {
    ...
    for (var i = t.length, l = r.length, s = e.oldPos, c = s - n, p = 0; c + 1 < i && s + 1 < l && this.equals(r[s + 1], t[c + 1], o); ) c++, s++, p++, o.oneChangePerToken && (e.lastComponent = { count: 1, previousComponent: e.lastComponent, added: false, removed: false });
...
`) && (t = t.slice(0, -1))), mt.prototype.equals.call(this, e, t, r);
  ...
  o0 = DF, xF = (wo = class {
    ...
    hasAncestor(t) {
      for (let r of Na(this, $r, cl).call(this)) if (t(r)) return true;
      return false;
    }
  }, a(wo, "Rt"), wo);
  ...
  wk = (So = class extends fr {
    ...
    _applyNormalization(t, r) {
      ...
      for (let l of o) {
        ...
        for (let { from: f, to: g } of h5.redirect) d({ value: f, redirectTo: g });
      }
      for (let l of i) {
        let s = t[l];
  ...
  function ns(e, t) {
    ...
    if (e && t && typeof e == "object" && typeof t == "object") {
      ...
      if (TM && e instanceof Map && t instanceof Map) {
        ...
        for (i = e.entries(); !(n = i.next()).done; )
          if (!ns(n.value[1], t.get(n.value[0]))) return false;
        return true;
      }
      ...
      if (LM && e instanceof Element) return false;
      for (n = r; n-- !== 0; )
...
//# sourceMappingURL=chunk-SW7KVG2U.js.map
